...
echo "Building saichler/erp-logs-vnet:${TAG} for ${PLATFORM}"
docker buildx build --no-cache --platform="$PLATFORM" -t saichler/erp-logs-vnet:${TAG} .
docker push saichler/erp-logs-vnet:${TAG}
