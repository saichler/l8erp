...
echo "Building saichler/erp-maint:${TAG} for ${PLATFORM}"
docker buildx build --no-cache --platform="$PLATFORM" -t saichler/erp-maint:${TAG} .
docker push saichler/erp-maint:${TAG}
