...
echo "Building saichler/erp-vnet:${TAG} for ${PLATFORM}"
docker buildx build --no-cache --platform="$PLATFORM" -t saichler/erp-vnet:${TAG} .
docker push saichler/erp-vnet:${TAG}
