...
func LendCollateralById(collateralId string, vnic ifs.IVNic) (*lend.LendCollateral, error) {
	result, err := common.GetEntity(ServiceName, ServiceArea, &lend.LendCollateral{CollateralId: collateralId}, vnic)
	if err != nil || result == nil {
		return nil, err
	}
	return result.(*lend.LendCollateral), nil
}
