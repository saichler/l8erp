...
*/
/**
 * ERP Reference Registry - Financial Models (Desktop)
 * Extends shared FIN data with desktop-specific BankAccount displayFormat
 */
(function() {
    'use strict';
    ...
    window.Layer8DReferenceRegistryFIN = {
        ...
        // Desktop-specific: BankAccount with custom displayFormat
        BankAccount: {
