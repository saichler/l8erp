        ...
        hcm: {
            ...
            services: {
                ...
                'payroll': [
                    ...
                    { key: 'pay-components', label: 'Pay Components', icon: 'pay-components', endpoint: '/30/PayComp', model: 'PayComponent', idField: 'componentId' },
                    ...
                    { key: 'tax-withholdings', label: 'Tax Withholdings', icon: 'tax-withholdings', endpoint: '/30/TaxWith', model: 'TaxWithholding', idField: 'withholdingId' },
                ...
                'benefits': [
                    { key: 'benefit-plans', label: 'Benefit Plans', icon: 'benefit-plans', endpoint: '/30/BenPlan', model: 'BenefitPlan', idField: 'planId' },
                ...
                'time': [
                    ...
                    { key: 'leave-requests', label: 'Leave Requests', icon: 'leave-requests', endpoint: '/30/LeaveReq', model: 'LeaveRequest', idField: 'requestId', supportedViews: ['table', 'kanban', 'calendar'] },
                    { key: 'leave-balances', label: 'Leave Balances', icon: 'leave-balances', endpoint: '/30/LeaveBal', model: 'LeaveBalance', idField: 'balanceId' },
                    { key: 'leave-policies', label: 'Leave Policies', icon: 'leave-policies', endpoint: '/30/LeavePol', model: 'LeavePolicy', idField: 'policyId' },
                ...
                'talent': [
                    ...
                    { key: 'succession', label: 'Succession Plans', icon: 'succession', endpoint: '/30/SuccPlan', model: 'SuccessionPlan', idField: 'planId' },
                ...
                'learning': [
                    ...
                    { key: 'emp-certifications', label: 'Emp. Certs', icon: 'emp-certifications', endpoint: '/30/EmpCert', model: 'EmployeeCertification', idField: 'employeeCertificationId' },
                    { key: 'skills', label: 'Skills', icon: 'skills', endpoint: '/30/Skill', model: 'Skill', idField: 'skillId' },
                    { key: 'emp-skills', label: 'Emp. Skills', icon: 'emp-skills', endpoint: '/30/EmpSkill', model: 'EmployeeSkill', idField: 'employeeSkillId' },
                ...
                'compensation': [
                    { key: 'salary-grades', label: 'Salary Grades', icon: 'salary-grades', endpoint: '/30/SalGrade', model: 'SalaryGrade', idField: 'gradeId' },
                    { key: 'salary-structures', label: 'Salary Structures', icon: 'salary-structures', endpoint: '/30/SalStrct', model: 'SalaryStructure', idField: 'structureId' },
                    { key: 'emp-compensation', label: 'Emp. Compensation', icon: 'emp-compensation', endpoint: '/30/EmpComp', model: 'EmployeeCompensation', idField: 'compensationId' },
                    { key: 'merit-increases', label: 'Merit Increases', icon: 'merit-increases', endpoint: '/30/MeritInc', model: 'MeritIncrease', idField: 'increaseId' },
                    { key: 'merit-cycles', label: 'Merit Cycles', icon: 'merit-cycles', endpoint: '/30/MrtCycle', model: 'MeritCycle', idField: 'cycleId' },
                    { key: 'bonus-plans', label: 'Bonus Plans', icon: 'bonus-plans', endpoint: '/30/BonusPlan', model: 'BonusPlan', idField: 'planId' },
                    { key: 'bonus-payments', label: 'Bonus Payments', icon: 'bonus-payments', endpoint: '/30/BonusPay', model: 'BonusPayment', idField: 'paymentId' },
