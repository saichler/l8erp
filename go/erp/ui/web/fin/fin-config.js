    ...
    FIN.modules = {
        'general-ledger': {
            ...
            services: [
                ...
                { key: 'journal-entry-lines', label: 'Entry Lines', icon: '📋', endpoint: '/40/JrnlLine', model: 'JournalEntryLine' },
                { key: 'fiscal-years', label: 'Fiscal Years', icon: '📅', endpoint: '/40/FiscalYr', model: 'FiscalYear' },
                { key: 'fiscal-periods', label: 'Fiscal Periods', icon: '📆', endpoint: '/40/FiscalPd', model: 'FiscalPeriod' },
                ...
                { key: 'account-balances', label: 'Balances', icon: '💰', endpoint: '/40/AcctBal', model: 'AccountBalance' }
            ]
        },
        'accounts-payable': {
            ...
            services: [
                ...
                { key: 'purchase-invoice-lines', label: 'Invoice Lines', icon: '📋', endpoint: '/40/PurchLine', model: 'PurchaseInvoiceLine' },
                ...
                { key: 'payment-allocations', label: 'Payment Allocations', icon: '🔗', endpoint: '/40/PmtAlloc', model: 'PaymentAllocation' },
        ...
        'accounts-receivable': {
            ...
            services: [
                ...
                { key: 'sales-invoice-lines', label: 'Invoice Lines', icon: '📋', endpoint: '/40/SalesLine', model: 'SalesInvoiceLine' },
                { key: 'customer-payments', label: 'Customer Payments', icon: '💳', endpoint: '/40/CustPmt', model: 'CustomerPayment' },
                { key: 'payment-applications', label: 'Payment Applications', icon: '🔗', endpoint: '/40/PmtApp', model: 'PaymentApplication' },
        ...
        'cash': {
            ...
            services: [
                ...
                { key: 'bank-reconciliations', label: 'Reconciliations', icon: '✅', endpoint: '/40/BankRec', model: 'BankReconciliation' },
        ...
        'fixed-assets': {
            ...
            services: [
                ...
                { key: 'depreciation-schedules', label: 'Depreciation', icon: '📉', endpoint: '/40/DeprSched', model: 'DepreciationSchedule' },
                { key: 'asset-disposals', label: 'Disposals', icon: '🗑️', endpoint: '/40/AstDisp', model: 'AssetDisposal' },
                { key: 'asset-transfers', label: 'Transfers', icon: '🔄', endpoint: '/40/AstXfer', model: 'AssetTransfer' },
                { key: 'asset-maintenance', label: 'Maintenance', icon: '🔧', endpoint: '/40/AstMaint', model: 'AssetMaintenance' },
                { key: 'asset-revaluations', label: 'Revaluations', icon: '📊', endpoint: '/40/AstReval', model: 'AssetRevaluation' }
            ]
        },
        'budgeting': {
            label: 'Budgeting',
            ...
            services: [
                ...
                { key: 'budget-transfers', label: 'Budget Transfers', icon: '🔄', endpoint: '/40/BdgtXfer', model: 'BudgetTransfer' },
                { key: 'budget-scenarios', label: 'Scenarios', icon: '🎯', endpoint: '/40/BdgtScen', model: 'BudgetScenario' },
        ...
        'tax': {
            ...
            services: [
                ...
                { key: 'tax-returns', label: 'Tax Returns', icon: '📄', endpoint: '/40/TaxRtn', model: 'TaxReturn' },
