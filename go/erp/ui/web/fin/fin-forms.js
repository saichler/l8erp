...
*/
// FIN Forms - Modal Form Generation and Handling
// Thin wrapper around ERPForms for FIN-specific needs
...
(function() {
    ...
    function generateFormHtml(formDef, data = {}) {
        ...
        let html = '<form id="fin-edit-form">';
    ...
    function collectFormData(formDef) {
        ...
        // Fallback implementation
        const form = document.getElementById('fin-edit-form') || document.getElementById('erp-edit-form');
        if (!form) return null;
