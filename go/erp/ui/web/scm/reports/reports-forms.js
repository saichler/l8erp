...
*/
// Supply Chain Reports - Form Definitions using Layer8FormFactory
...
(function() {
    ...
    var enums = ScmReports.enums;

    ScmReports.forms = {
        ScmReport: f.form('Supply Chain Report', [
            ...
            // Filled by generateScmReport() on POST. Read-only because anything
