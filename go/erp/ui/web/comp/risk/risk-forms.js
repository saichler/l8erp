    ...
    CompRisk.forms = {
        CompRiskRegister: f.form('Risk Register', [
            f.section('Risk Information', [
                ...
                ...f.text('triggerEvents', 'Trigger Events'),
            ]),
        ...
        CompIncident: f.form('Incident', [
            f.section('Incident Information', [
                ...
                ...f.select('category', 'Category', enums.riskCategory),
                ...f.date('discoveredDate', 'Discovered Date'),
                ...f.text('reportedById', 'Reported By'),
                ...f.text('assignedToId', 'Assigned To'),
                ...f.text('departmentId', 'Department'),
                ...f.text('correctiveAction', 'Corrective Action'),
                ...f.text('preventiveAction', 'Preventive Action'),
        ...
        CompInsurancePolicy: f.form('Insurance Policy', [
            f.section('Policy Information', [
                ...
                ...f.text('coveredRisks', 'Covered Risks'),
                ...f.text('exclusions', 'Exclusions'),
                ...f.text('policyDocumentId', 'Policy Document'),
