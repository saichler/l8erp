    ...
    window.Learning.forms = {
        ...
        CourseEnrollment: f.form('Course Enrollment', [
            ...
            f.section('Progress & Results', [
                ...f.number('progressPercentage', 'Progress'),
                ...f.number('score', 'Score'),
                ...f.checkbox('passed', 'Passed'),
                ...f.number('attempts', 'Attempts')
            ]),
            f.section('Feedback', [
                ...f.number('employeeRating', 'Employee Rating'),
        ...
        EmployeeSkill: f.form('Employee Skill', [
            ...
            f.section('Proficiency', [
                ...f.number('proficiencyLevel', 'Proficiency Level', true),
                ...f.number('selfAssessedLevel', 'Self-Assessed Level'),
                ...f.number('managerAssessedLevel', 'Manager-Assessed Level'),
