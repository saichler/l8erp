...
*/
/**
 * MobileAuth - Authentication utilities for ERP mobile app
...
(function() {
    ...
    window.MobileAuth = {
        ...
        async makeAuthenticatedRequest(url, options = {}) {
            ...
            if (!token) {
                console.error('MobileAuth: No bearer token');
        ...
        async verifyTfa(code) {
            ...
            try {
                ...
                console.error('MobileAuth: TFA verification failed:', error);
                return { success: false, error: error.message };
            }
        },
        ...
        async getTfaSetup() {
            ...
            try {
                ...
                console.error('MobileAuth: TFA setup fetch failed:', error);
                return { success: false, error: error.message };
            }
        },
        ...
        async verifyTfaSetup(code) {
            ...
            try {
                ...
                console.error('MobileAuth: TFA setup verification failed:', error);
                return { success: false, error: error.message };
            }
        },
