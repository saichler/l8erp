...
(function() {
    ...
    MobileMfgProduction.primaryKeys = {
        MfgWorkOrder: 'workOrderId', MfgWorkOrderOp: 'operationId', MfgProductionOrder: 'prodOrderId',
        MfgProdOrderLine: 'lineId', MfgProdBatch: 'batchId', MfgProdConsumption: 'consumptionId'
    };
