...
(function() {
    ...
    MobileGeneralLedger.columns = {
        ...
        JournalEntry: [
            ...
            { key: 'entryDate', label: 'Date', sortKey: 'entryDate', render: (item) => MobileRenderers.renderDate(item.entryDate) },
            ...
            { key: 'totalDebit', label: 'Total Debit', sortKey: 'totalDebit', render: (item) => MobileRenderers.renderMoney(item.totalDebit) }
        ],
        ...
        JournalEntryLine: [
            ...
            { key: 'debitAmount', label: 'Debit', sortKey: 'debitAmount', render: (item) => MobileRenderers.renderMoney(item.debitAmount) },
            { key: 'creditAmount', label: 'Credit', sortKey: 'creditAmount', render: (item) => MobileRenderers.renderMoney(item.creditAmount) },
            { key: 'description', label: 'Description', sortKey: 'description', filterKey: 'description' }
        ],
        ...
        FiscalYear: [
            ...
            { key: 'isClosed', label: 'Closed', sortKey: 'isClosed', render: (item) => MobileRenderers.renderBoolean(item.isClosed) }
        ],
        ...
        AccountBalance: [
            ...
            { key: 'debitBalance', label: 'Debit', sortKey: 'debitBalance', render: (item) => MobileRenderers.renderMoney(item.debitBalance) },
            { key: 'creditBalance', label: 'Credit', sortKey: 'creditBalance', render: (item) => MobileRenderers.renderMoney(item.creditBalance) }
        ]
    };
