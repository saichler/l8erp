...
*/
/**
 * Mobile Lending Payments Module - Column Configurations
 * Desktop Equivalent: lending/payments/payments-columns.js
 */
(function() {
    'use strict';
    ...
    var render = MobileLendPayments.render;

    MobileLendPayments.columns = {
        LendPayment: [
            ...col.id('paymentId'),
    ...
    MobileLendPayments.primaryKeys = {
