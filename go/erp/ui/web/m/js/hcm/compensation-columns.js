...
(function() {
    ...
    MobileCompensation.columns = {
        SalaryGrade: [
            ...
            { key: 'midpoint', label: 'Midpoint', sortKey: 'midpoint', render: (item) => MobileRenderers.renderMoney(item.midpoint) },
        ...
        EmployeeCompensation: [
            ...
            { key: 'baseSalary', label: 'Base Salary', sortKey: 'baseSalary', render: (item) => MobileRenderers.renderMoney(item.baseSalary) },
            { key: 'payFrequency', label: 'Frequency', sortKey: 'payFrequency', filterKey: 'payFrequency', enumValues: enums.PAY_FREQUENCY_VALUES, render: (item) => render.payFrequency(item.payFrequency) },
        ...
        MeritIncrease: [
            ...
            { key: 'currentSalary', label: 'Current', sortKey: 'currentSalary', render: (item) => MobileRenderers.renderMoney(item.currentSalary) },
            { key: 'proposedIncrease', label: 'Increase', sortKey: 'proposedIncrease', render: (item) => MobileRenderers.renderMoney(item.proposedIncrease) },
        ...
        MeritCycle: [
            ...
            { key: 'totalBudget', label: 'Budget', sortKey: 'totalBudget', render: (item) => MobileRenderers.renderMoney(item.totalBudget) },
        ...
        BonusPayment: [
            ...
            { key: 'actualAmount', label: 'Amount', sortKey: 'actualAmount', render: (item) => MobileRenderers.renderMoney(item.actualAmount) },
        ...
        EquityGrant: [
            ...
            { key: 'grantPrice', label: 'Grant Price', sortKey: 'grantPrice', render: (item) => MobileRenderers.renderMoney(item.grantPrice) },
            ...
            { key: 'grantDate', label: 'Grant Date', sortKey: 'grantDate', render: (item) => MobileRenderers.renderDate(item.grantDate) }
        ],
        ...
        CompensationStatement: [
            ...
            { key: 'baseSalary', label: 'Base Salary', sortKey: 'baseSalary', render: (item) => MobileRenderers.renderMoney(item.baseSalary) },
            { key: 'bonusActual', label: 'Bonus', sortKey: 'bonusActual', render: (item) => MobileRenderers.renderMoney(item.bonusActual) },
            { key: 'equityValue', label: 'Equity', sortKey: 'equityValue', render: (item) => MobileRenderers.renderMoney(item.equityValue) },
            { key: 'totalCashCompensation', label: 'Total Cash', sortKey: 'totalCashCompensation', render: (item) => MobileRenderers.renderMoney(item.totalCashCompensation) },
            { key: 'totalCompensation', label: 'Total Comp', sortKey: 'totalCompensation', render: (item) => MobileRenderers.renderMoney(item.totalCompensation) }
        ],
        ...
        MarketBenchmark: [
            ...
            { key: 'market50th', label: '50th %ile', sortKey: 'market50th', render: (item) => MobileRenderers.renderMoney(item.market50th) },
            { key: 'market75th', label: '75th %ile', sortKey: 'market75th', render: (item) => MobileRenderers.renderMoney(item.market75th) },
            { key: 'internalAverage', label: 'Internal Avg', sortKey: 'internalAverage', render: (item) => MobileRenderers.renderMoney(item.internalAverage) },
