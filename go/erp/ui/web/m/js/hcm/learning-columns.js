...
(function() {
    ...
    MobileLearning.columns = {
        ...
        CourseEnrollment: [
            ...
            { key: 'passed', label: 'Passed', sortKey: 'passed', render: (item) => Layer8MRenderers.renderBoolean(item.passed, { trueText: 'Pass', falseText: 'Fail' }) },
        ...
        EmployeeCertification: [
            ...
            { key: 'expirationDate', label: 'Expiration', sortKey: 'expirationDate', render: (item) => Layer8MRenderers.renderDate(item.expirationDate) },
        ...
        EmployeeSkill: [
            ...
            { key: 'isPrimarySkill', label: 'Primary', sortKey: 'isPrimarySkill', render: (item) => Layer8MRenderers.renderBoolean(item.isPrimarySkill) },
            { key: 'lastUsedDate', label: 'Last Used', sortKey: 'lastUsedDate', render: (item) => Layer8MRenderers.renderDate(item.lastUsedDate) }
        ],
        ...
        TrainingRecord: [
            ...
            { key: 'expirationDate', label: 'Expiration', sortKey: 'expirationDate', render: (item) => Layer8MRenderers.renderDate(item.expirationDate) },
            { key: 'passed', label: 'Passed', sortKey: 'passed', render: (item) => Layer8MRenderers.renderBoolean(item.passed, { trueText: 'Pass', falseText: 'Fail' }) },
            { key: 'isCompliant', label: 'Compliant', sortKey: 'isCompliant', render: (item) => Layer8MRenderers.renderBoolean(item.isCompliant) }
        ]
    };
