...
*/
/**
 * Mobile Documents Module Registry
 * Unified access to all Documents sub-module configurations
 * Desktop Equivalent: documents/documents-config.js
 */
(function() {
    'use strict';
     ...
     * @param {string} modelName - The model name (e.g., 'DocDocument', 'DocFolder')
     ...
     * @param {string} modelName - The model name
     * @returns {string|null} Module name (e.g., 'Storage', 'Workflow')
     */
    function getModuleName(modelName) {
        const mod = findModule(modelName);
        if (!mod) return null;

        if (mod === MobileDocStorage) return 'Storage';
        if (mod === MobileDocWorkflow) return 'Workflow';
        if (mod === MobileDocIntegration) return 'Integration';
        if (mod === MobileDocCompliance) return 'Compliance';
