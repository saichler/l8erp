...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	sla := common.NewOrmSLA(ServiceName, ServiceArea, "SegmentId", newCustomerSegmentServiceCallback(vnic),
		&sales.SalesCustomerSegment{}, &sales.SalesCustomerSegmentList{})
