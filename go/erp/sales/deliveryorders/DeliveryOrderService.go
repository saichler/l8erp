...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	sla := common.NewOrmSLA(ServiceName, ServiceArea, "DeliveryOrderId", newDeliveryOrderServiceCallback(vnic),
		&sales.SalesDeliveryOrder{}, &sales.SalesDeliveryOrderList{})
