...
const (
	ServiceName = "SalesRept"
	ServiceArea = byte(60)
)

// The service owns SalesReport -- its own protobuf type, not fin.FinReport. Seven
...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	common.ActivateReportService(ServiceName, ServiceArea, creds, dbname, vnic,
		salesReportAccessors(vnic), &sales.SalesReport{}, &sales.SalesReportList{})
}
