...
const (
	ServiceName = "ModConfig"
	ServiceArea = byte(0)
)

func Activate(creds, dbname string, vnic ifs.IVNic) {
	sla := common.NewOrmSLA(ServiceName, ServiceArea, "ConfigId", newSysModuleConfigServiceCallback(vnic),
		&sys.SysModuleConfig{}, &sys.SysModuleConfigList{})
