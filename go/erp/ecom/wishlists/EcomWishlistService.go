...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	sla := common.NewOrmSLA(ServiceName, ServiceArea, "WishlistId", newEcomWishlistServiceCallback(vnic),
		&ecom.EcomWishlist{}, &ecom.EcomWishlistList{})
...
func EcomWishlist(wishlistId string, vnic ifs.IVNic) (*ecom.EcomWishlist, error) {
	...
	return result.(*ecom.EcomWishlist), nil
}
