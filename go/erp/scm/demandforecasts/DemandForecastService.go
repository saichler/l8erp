...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	sla := common.NewOrmSLA(ServiceName, ServiceArea, "ForecastId", newDemandForecastServiceCallback(vnic),
		&scm.ScmDemandForecast{}, &scm.ScmDemandForecastList{})
...
func DemandForecast(forecastId string, vnic ifs.IVNic) (*scm.ScmDemandForecast, error) {
	...
	return result.(*scm.ScmDemandForecast), nil
}
