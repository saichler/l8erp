...
type RequestForQuotationServiceCallback struct{}

func newRequestForQuotationServiceCallback() *RequestForQuotationServiceCallback {
	return &RequestForQuotationServiceCallback{}
}
...
func (this *RequestForQuotationServiceCallback) After(any interface{}, action ifs.Action, cont bool, vnic ifs.IVNic) (interface{}, bool, error) {
	return nil, true, nil
}
