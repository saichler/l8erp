...
type SupplyPlanServiceCallback struct{}

func newSupplyPlanServiceCallback() *SupplyPlanServiceCallback {
	return &SupplyPlanServiceCallback{}
}
...
func (this *SupplyPlanServiceCallback) After(any interface{}, action ifs.Action, cont bool, vnic ifs.IVNic) (interface{}, bool, error) {
	return nil, true, nil
}
