...
type ReorderPointServiceCallback struct{}

func newReorderPointServiceCallback() *ReorderPointServiceCallback {
	return &ReorderPointServiceCallback{}
}
...
func (this *ReorderPointServiceCallback) After(any interface{}, action ifs.Action, cont bool, vnic ifs.IVNic) (interface{}, bool, error) {
	return nil, true, nil
}
