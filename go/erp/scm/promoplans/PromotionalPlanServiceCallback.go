...
type PromotionalPlanServiceCallback struct{}

func newPromotionalPlanServiceCallback() *PromotionalPlanServiceCallback {
	return &PromotionalPlanServiceCallback{}
}
...
func (this *PromotionalPlanServiceCallback) After(any interface{}, action ifs.Action, cont bool, vnic ifs.IVNic) (interface{}, bool, error) {
	return nil, true, nil
}
