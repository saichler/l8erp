...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	common.ActivateService[scm.ScmCarrier, scm.ScmCarrierList](common.ServiceConfig{
...
func Carrier(carrierId string, vnic ifs.IVNic) (*scm.ScmCarrier, error) {
	return common.GetEntity(ServiceName, ServiceArea, &scm.ScmCarrier{CarrierId: carrierId}, vnic)
}
