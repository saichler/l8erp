...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	sla := common.NewOrmSLA(ServiceName, ServiceArea, "CertificationId", newCompCertificationServiceCallback(vnic),
		&comp.CompCertification{}, &comp.CompCertificationList{})
