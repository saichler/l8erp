...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	common.ActivateService[hcm.Garnishment, hcm.GarnishmentList](common.ServiceConfig{
		...
		PrimaryKey: "GarnishmentId", Callback: newGarnishmentServiceCallback(), EnableCache: true,
	}, creds, dbname, vnic)
}
...
func Garnishment(garnishmentId string, vnic ifs.IVNic) (*hcm.Garnishment, error) {
	return common.GetEntity(ServiceName, ServiceArea, &hcm.Garnishment{GarnishmentId: garnishmentId}, vnic)
}
