...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	...
	ws.AddEndpoint(&hcm.MarketBenchmark{}, ifs.POST, &l8web.L8Empty{})
	ws.AddEndpoint(&hcm.MarketBenchmarkList{}, ifs.POST, &l8web.L8Empty{})
	ws.AddEndpoint(&hcm.MarketBenchmark{}, ifs.PUT, &l8web.L8Empty{})
	ws.AddEndpoint(&hcm.MarketBenchmark{}, ifs.PATCH, &l8web.L8Empty{})
	ws.AddEndpoint(&l8api.L8Query{}, ifs.DELETE, &l8web.L8Empty{})
	ws.AddEndpoint(&l8api.L8Query{}, ifs.GET, &hcm.MarketBenchmarkList{})
