...
func Activate(creds, dbname string, vnic ifs.IVNic) {
	common.ActivateService[hcm.LeaveBalance, hcm.LeaveBalanceList](common.ServiceConfig{
		...
		PrimaryKey: "BalanceId", Callback: newLeaveBalanceServiceCallback(), EnableCache: true,
	}, creds, dbname, vnic)
}
...
func LeaveBalance(balanceId string, vnic ifs.IVNic) (*hcm.LeaveBalance, error) {
	return common.GetEntity(ServiceName, ServiceArea, &hcm.LeaveBalance{BalanceId: balanceId}, vnic)
}
