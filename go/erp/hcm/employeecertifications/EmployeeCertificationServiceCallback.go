...
type EmployeeCertificationServiceCallback struct {
}

func newEmployeeCertificationServiceCallback() *EmployeeCertificationServiceCallback {
	return &EmployeeCertificationServiceCallback{}
}

func (this *EmployeeCertificationServiceCallback) Before(any interface{}, action ifs.Action, cont bool, vnic ifs.IVNic) (interface{}, bool, error) {
	entity, ok := any.(*hcm.EmployeeCertification)
	if !ok {
...
func (this *EmployeeCertificationServiceCallback) After(any interface{}, action ifs.Action, cont bool, vnic ifs.IVNic) (interface{}, bool, error) {
	return nil, true, nil
}
